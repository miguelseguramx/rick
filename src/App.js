...
class App extends React.Component {
  ...
  render() {
    const { modalActivo, personajes,personajeSeleccionado } = this.state
          ...
          { modalActivo ? (
            <div className='Modal' onClick={e => this.desactivarModal()}>
              <div className='Card-detalle'>
                <div className='Card-imagen'>
                  <figure>
                    <img alt='test' src={personajeSeleccionado.image} />
                  </figure>
                </div>
                <div className='Card-detalle-descripcion'>
                  <div className='descripcion'>
                    ...
                    <div className='caracteristica'>
                      <p>Origen</p>
                      <p className='caracteristica-valor'>
                        {personajeSeleccionado.origin.name}
                      </p>
                    </div>
                  </div>
                </div>
